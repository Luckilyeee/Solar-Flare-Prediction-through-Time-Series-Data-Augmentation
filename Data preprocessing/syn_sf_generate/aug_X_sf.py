...
for name in ['Solarflare']:
    try:
        ...
        X_train = np.load("/home/dmlab_a/Peiyu/aug_sf/data/stra_sampling/xtrain_subsampled.npy")
        y_train = np.load("/home/dmlab_a/Peiyu/aug_sf/data/stra_sampling/ytrain_subsampled.npy")
        print(X_train.shape)
