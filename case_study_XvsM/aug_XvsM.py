...
from syn.utils import augmentation as aug
...
for name in ['Solarflare']:
    try:
        ...
        X_train = np.load("/home/dmlab_a/Peiyu/aug_sf/data/XvsM/train/xtrain.npy")
        y_train = np.load("/home/dmlab_a/Peiyu/aug_sf/data/XvsM/train/xtrain.npy")
        print(X_train.shape)
