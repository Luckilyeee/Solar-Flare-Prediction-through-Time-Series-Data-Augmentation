...
class Classifier_RESNET:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        reduce_lr = keras.callbacks.ReduceLROnPlateau(monitor='val_loss', factor=0.05, patience=10, min_lr=0.00001)
        ...
        early_stopping = keras.callbacks.EarlyStopping(monitor='val_loss', patience=20, mode='min')
